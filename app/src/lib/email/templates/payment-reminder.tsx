...
export function generatePaymentReminder(data: PaymentReminderData): {
  subject: string;
  html: string;
} {
  ...
  const overdueText =
    data.daysOverdue > 0
      ? `This invoice is <strong style="color:#e53e3e;">${data.daysOverdue} day${data.daysOverdue !== 1 ? "s" : ""} overdue</strong>.`
      : `This invoice payment is due soon.`;
      ...
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
          ...
          ${
            data.daysOverdue > 0
              ? `<tr>
            <td style="background-color:#fff5f5;border-bottom:3px solid #e53e3e;padding:16px 40px;">
              <p style="margin:0;font-size:14px;color:#c53030;text-align:center;">
                ⚠️ Payment is ${data.daysOverdue} day${data.daysOverdue !== 1 ? "s" : ""} overdue
              </p>
            </td>
          </tr>`
              : ""
            ...
            <td style="padding:40px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e5e5e5;border-radius:8px;overflow:hidden;margin-bottom:32px;">
                <tr style="background-color:#fafafa;">
                  <td style="padding:16px 20px;font-size:12px;font-weight:600;color:#888888;text-transform:uppercase;letter-spacing:0.5px;border-bottom:1px solid #e5e5e5;" colspan="2">Outstanding Invoice</td>
                </tr>
                <tr>
                ...
                ${
                  ...
                  <td style="padding:14px 20px;font-size:14px;color:${data.daysOverdue > 0 ? "#e53e3e" : "#111111"};font-weight:600;text-align:right;border-bottom:1px solid #f0f0f0;">${formatDate(data.dueDate)}</td>
                </tr>`
                    : ""
                }
                <tr style="background-color:#fff8f5;">
                  <td style="padding:18px 20px;font-size:16px;font-weight:700;color:#111111;">Amount Due</td>
              ...
              <p style="margin:0 0 32px;font-size:14px;color:#777777;line-height:1.6;">
                If you've already sent payment, please disregard this message. If you have any questions, feel free to reply to this email.
              </p>
